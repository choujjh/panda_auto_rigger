...
class SingleXform(base_comp.Anim):
    ...
    def _override_build(self, control_color=None, setup_color=None, **kwargs):
        ...
        cntrl_mult_matrix["matrixIn"][0]  << setup_inst.get_xform_attrs(xform_type=self.IO_ENUM.output, index=0)[self.HIER_DATA.OUTPUT_WORLD_MATRIX]
        ...
        self._set_xform_attrs(
            ...
            init_matrix=setup_inst_out_xform[self.HIER_DATA.OUTPUT_INIT_MATRIX],
            init_inv_matrix=setup_inst_out_xform[self.HIER_DATA.OUTPUT_INIT_INV_MATRIX],

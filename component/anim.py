...
class _Anim(base_comp._Hierarchy):
    ...
    @property
    def settings_component(self)->control._Control:
    ...
    @property
    def settings_guide_component(self)->control._Control:
    ...
    @property
    def mirror_dest_component(self)->"_Anim":
    ...
    @property
    def mirror_src_component(self)->"_Anim":
